	...
	do_scatterplots(cfg.getParameter<bool>("do_scatterplots"))
{
	...
	h_close_more_svlsp_svdistdz_dzsigma = fs->make<TH1F>("h_close_more_svlsp_svdist2d_dzsigma", "nsv >= 2, dist3d(gen vtx, sv w/ more tracks) < 85 um, svdPhi < 0.5; #frac{svdistdz}{sig svdistdz}", 100, 0, 10);
