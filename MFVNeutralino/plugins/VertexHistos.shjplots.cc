...
class MFVVertexHistos : public edm::EDAnalyzer {
 ...
 private:
  ...
  Measurement1D miss_dist(const reco::Vertex& sv0, const reco::Vertex& sv1, const AlgebraicVector3& mom) {
  ...
  Measurement1D miss_dist_max_rm(const reco::Vertex& sv0, const reco::Vertex& sv1, const math::XYZTLorentzVector& mom_max) {
	  // miss distance is magnitude of (jet direction (= n) cross (tv - sv) ( = d))
	  // to calculate uncertainty, use |n X d|^2 = (|n||d|)^2 - (n . d)^2
