...
private:
	...
	TH1F* h_ratio_diff_pT_sum_sv_nsv2_small_no_shj;
	TH1F* h_ratio_diff_pT_sum_major_minor_sv_nsv2_no_shj;
	TH1F* h_ratio_diff_pT_sum_major_minor_sv_nsv2_small_no_shj;
	
	TH1F* h_sv_njets_nsv1;
	TH1F* h_sv_njets_small_nsv2_no_shj;
	

	TH1F* h_ratio_ntracks_small_nsv2_shared_jets;
	TH1F* h_sv_njets_small_nsv2_shj;
	TH1F* h_sv_njets_no_less_sum_pt_shared_tracks_small_nsv2;
	TH1F* h_sv_njets_no_less_ratio_sum_pt_shared_tracks_small_nsv2;
	TH1F* h_poor_sv_njets_no_less_sum_pt_shared_tracks_small_nsv2;
	TH1F* h_poor_sv_njets_no_less_ratio_sum_pt_shared_tracks_small_nsv2;
	//efficiency plots for all shared jets 
	TH2F* h_2D_sv_tracks_small_nsv2;
	TH2F* h_2D_sv_tracks_shared_jets_small_nsv2;
	TH2F* h_2D_sv_tracks_no_shared_tracks_small_nsv2;
	TH2F* h_2D_sv_tracks_no_minor_shared_tracks_small_nsv2;
	...
	TH2F* h_2D_sv_tracks_no_less_sum_pt_shared_tracks_small_nsv2_more_nshj3;

	TH2F* h_2D_poor_sv_tracks_no_less_sum_pt_shared_tracks_small_nsv2;
	TH2F* h_2D_poor_sv_tracks_no_less_sum_pt_shared_tracks_small_nsv2_nshj1;	  //repetitive 
	TH2F* h_2D_poor_sv_tracks_no_less_sum_pt_shared_tracks_small_nsv2_nshj2;
	TH2F* h_2D_poor_sv_tracks_no_less_sum_pt_shared_tracks_small_nsv2_more_nshj3;

	TH2F* h_2D_sv_tracks_no_less_ratio_sum_pt_shared_tracks_small_nsv2;
	TH2F* h_2D_sv_tracks_no_less_ratio_avg_pt_shared_tracks_small_nsv2;
	TH2F* h_2D_sv_tracks_no_less_avg_pt_shared_tracks_small_nsv2;
	TH2F* h_2D_poor_sv_tracks_no_less_ratio_sum_pt_shared_tracks_small_nsv2;
	TH2F* h_2D_poor_sv_tracks_no_less_ratio_avg_pt_shared_tracks_small_nsv2;
	TH2F* h_2D_poor_sv_tracks_no_less_avg_pt_shared_tracks_small_nsv2;

	TH1F* h_diff_pT_avg_dPhi_shj_sv_small_nsv2;
	TH1F* h_diff_ratio_pT_avg_dPhi_shj_sv_small_nsv2;
	TH1F* h_diff_pT_sum_dPhi_shj_sv_small_nsv2;
	TH1F* h_diff_ratio_pT_sum_dPhi_shj_sv_small_nsv2;

	TH2F* h_2D_sv_tracks_no_less_ratio_sum_pt_shared_tracks_nshj1_small_nsv2;
	TH2F* h_2D_sv_tracks_no_less_ratio_avg_pt_shared_tracks_nshj1_small_nsv2;
	TH2F* h_2D_sv_tracks_no_less_sum_pt_shared_tracks_nshj1_small_nsv2;
	TH2F* h_2D_sv_tracks_no_less_avg_pt_shared_tracks_nshj1_small_nsv2;
	TH2F* h_2D_sv_tracks_no_minor_less_ratio_sum_pt_shared_tracks_nshj1_small_nsv2;
	TH2F* h_2D_sv_tracks_no_minor_less_ratio_avg_pt_shared_tracks_nshj1_small_nsv2;
	TH2F* h_2D_sv_tracks_no_minor_less_sum_pt_shared_tracks_nshj1_small_nsv2;
	TH2F* h_2D_sv_tracks_no_minor_less_avg_pt_shared_tracks_nshj1_small_nsv2;

	TH2F* h_2D_poor_sv_tracks_shared_jets_nshj1_small_nsv2;
	TH2F* h_2D_poor_sv_tracks_no_shared_tracks_nshj1_small_nsv2;
	TH2F* h_2D_poor_sv_tracks_no_minor_shared_tracks_nshj1_small_nsv2;
	TH2F* h_2D_poor_sv_tracks_no_less_ratio_sum_pt_shared_tracks_nshj1_small_nsv2;
	TH2F* h_2D_poor_sv_tracks_no_less_ratio_avg_pt_shared_tracks_nshj1_small_nsv2;
	TH2F* h_2D_poor_sv_tracks_no_less_sum_pt_shared_tracks_nshj1_small_nsv2;
	TH2F* h_2D_poor_sv_tracks_no_less_avg_pt_shared_tracks_nshj1_small_nsv2;
	TH2F* h_2D_poor_sv_tracks_no_minor_less_ratio_sum_pt_shared_tracks_nshj1_small_nsv2;
	TH2F* h_2D_poor_sv_tracks_no_minor_less_ratio_avg_pt_shared_tracks_nshj1_small_nsv2;
	TH2F* h_2D_poor_sv_tracks_no_minor_less_sum_pt_shared_tracks_nshj1_small_nsv2;
	TH2F* h_2D_poor_sv_tracks_no_minor_less_avg_pt_shared_tracks_nshj1_small_nsv2;
	...
	TH2F* h_2D_nsharedjets_svdPhi_small_nsv2_shared_jets;
	TH2F* h_2D_nsharedjets_svdPhi_large_nsv2_shared_jets;
	...
	do_scatterplots(cfg.getParameter<bool>("do_scatterplots"))
{
	...
	h_ratio_diff_pT_sum_sv_nsv2_small_no_shj = fs->make<TH1F>("h_ratio_diff_pT_sum_sv_nsv2_small_no_shj", "nsv = 2, absdeltaphi01 <= 0.5, no shared jets; #frac{sv0 shared sum pT - sv1 shared sum pT}{sv0 shared sum pT + sv1 shared sum pT}", 40, -2, 2);
	...
	h_ratio_diff_pT_sum_major_minor_sv_nsv2_small_no_shj = fs->make<TH1F>("h_ratio_diff_pT_sum_major_minor_sv_nsv2_small_no_shj", "nsv = 2, absdeltaphi01 <= 0.5, no shared jets; #frac{major shared sum pT - minor shared sum pT}{major shared sum pT + minor shared sum pT}", 40, -2, 2);

	h_sv_njets_nsv1 = fs->make<TH1F>("h_sv_njets_small_nsv1", "nsv = 1; # of jets/SV;arb. units", 10, 0, 10);
	h_sv_njets_small_nsv2_no_shj = fs->make<TH1F>("h_sv_njets_small_nsv2_no_shj", "nsv = 2, absdPhi01 <= 0.5, no shared jets; # of jets/SV;arb. units", 10, 0, 10);

	h_ratio_ntracks_small_nsv2_shared_jets = fs->make<TH1F>("h_ratio_ntracks_small_nsv2_shared_jets", "nsv = 2, absdPhi01 <= 0.5, shared jets;ratios of shared tracks (>1);arb. units", 50, 0, 10);

	h_sv_njets_small_nsv2_shj = fs->make<TH1F>("h_sv_njets_small_nsv2_shj", "nsv = 2, absdPhi01 <= 0.5, shared jets; # of jets/SV;arb. units", 10, 0, 10);
	h_sv_njets_no_less_sum_pt_shared_tracks_small_nsv2 = fs->make<TH1F>("h_sv_njets_no_less_sum_pt_shared_tracks_small_nsv2", "nsv = 2, absdPhi01 <= 0.5, no less_{sum p_{T}} shared tracks; # of jets/SV;arb. units", 10, 0, 10);
	h_sv_njets_no_less_ratio_sum_pt_shared_tracks_small_nsv2 = fs->make<TH1F>("h_sv_njets_no_less_ratio_sum_pt_shared_tracks_small_nsv2", "nsv = 2, absdPhi01 <= 0.5, no less_{ratio sum p_{T}} shared tracks; # of jets/SV;arb. units", 10, 0, 10);
	h_poor_sv_njets_no_less_sum_pt_shared_tracks_small_nsv2 = fs->make<TH1F>("h_poor_sv_njets_no_less_sum_pt_shared_tracks_small_nsv2", "poor nsv = 2, absdPhi01 <= 0.5, no less_{sum p_{T}} shared tracks; # of jets/SV;arb. units", 10, 0, 10);
	h_poor_sv_njets_no_less_ratio_sum_pt_shared_tracks_small_nsv2 = fs->make<TH1F>("h_poor_sv_njets_no_less_ratio_sum_pt_shared_tracks_small_nsv2", "poor nsv = 2, absdPhi01 <= 0.5, no less_{ratio sum p_{T}} shared tracks; # of jets/SV;arb. units", 10, 0, 10);

	h_2D_sv_tracks_small_nsv2 = fs->make<TH2F>("h_2D_sv_tracks_small_nsv2", "nsv = 2, absdPhi01 <= 0.5; # vtx's more tracks; # vtx's less tracks", 50, 0, 50, 50, 0, 50);
	h_2D_sv_tracks_shared_jets_small_nsv2 = fs->make<TH2F>("h_2D_sv_tracks_shared_jets_small_nsv2", "nsv = 2, absdPhi01 <= 0.5, shared jets; # vtx's more tracks; # vtx's less tracks", 50, 0, 50, 50, 0, 50);
    h_2D_sv_tracks_no_shared_tracks_small_nsv2 = fs->make<TH2F>("h_2D_sv_tracks_no_shared_tracks_small_nsv2", "nsv = 2, absdPhi01 <= 0.5, no shared tracks; # major vtx's tracks; # minor vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_sv_tracks_no_minor_shared_tracks_small_nsv2 = fs->make<TH2F>("h_2D_sv_tracks_no_minor_shared_tracks_small_nsv2", "nsv = 2, absdPhi01 <= 0.5, no minor tracks;  # major vtx's tracks; # minor vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_sv_tracks_no_less_sum_pt_shared_tracks_small_nsv2 = fs->make<TH2F>("h_2D_sv_tracks_no_less_sum_pt_shared_tracks_small_nsv2", "nsv = 2, absdPhi01 <= 0.5, no less_{sum p_{T}} shared tracks; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_sv_tracks_no_less_sum_pt_shared_tracks_small_nsv2_nshj1 = fs->make<TH2F>("h_2D_sv_tracks_no_less_sum_pt_shared_tracks_small_nsv2_nshj1", "nsv = 2, absdPhi01 <= 0.5, nshj=1, no less_{sum p_{T}} shared tracks; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_sv_tracks_no_less_sum_pt_shared_tracks_small_nsv2_nshj2 = fs->make<TH2F>("h_2D_sv_tracks_no_less_sum_pt_shared_tracks_small_nsv2_nshj2", "nsv = 2, absdPhi01 <= 0.5, nshj=2, no less_{sum p_{T}} shared tracks; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_sv_tracks_no_less_sum_pt_shared_tracks_small_nsv2_more_nshj3 = fs->make<TH2F>("h_2D_sv_tracks_no_less_sum_pt_shared_tracks_small_nsv2_more_nshj3", "nsv = 2, absdPhi01 <= 0.5, nshj>=3, no less_{sum p_{T}} shared tracks; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);

	h_diff_pT_avg_dPhi_shj_sv_small_nsv2 = fs->make<TH1F>("h_diff_pT_avg_dPhi_shj_sv_small_nsv2", "nsv = 2, absdPhi01 <= 0.5 ;delta(phi of a shared jet, phi of vtx w/ more_{avg p_{T}} );arb. units", 31, 0, 3.16);
	h_diff_ratio_pT_avg_dPhi_shj_sv_small_nsv2 = fs->make<TH1F>("h_diff_ratio_pT_avg_dPhi_shj_sv_small_nsv2", "nsv = 2, absdPhi01 <= 0.5 ;delta(phi of a shared jet, phi of vtx w/ more_{ratio avg p_{T}} );arb. units", 31, 0, 3.16);
	h_diff_pT_sum_dPhi_shj_sv_small_nsv2 = fs->make<TH1F>("h_diff_pT_sum_dPhi_shj_sv_small_nsv2", "nsv = 2, absdPhi01 <= 0.5 ;delta(phi of a shared jet, phi of vtx w/ more_{sum p_{T}} );arb. units", 31, 0, 3.16);
	h_diff_ratio_pT_sum_dPhi_shj_sv_small_nsv2 = fs->make<TH1F>("h_diff_ratio_pT_sum_dPhi_shj_sv_small_nsv2", "nsv = 2, absdPhi01 <= 0.5 ;delta(phi of a shared jet, phi of vtx w/ more_{ratio sum p_{T}} );arb. units", 31, 0, 3.16);

	h_2D_poor_sv_tracks_no_less_sum_pt_shared_tracks_small_nsv2 = fs->make<TH2F>("h_2D_poor_sv_tracks_no_less_sum_pt_shared_tracks_small_nsv2", "poor nsv = 2, absdPhi01 <= 0.5, no less_{sum p_{T}} shared tracks; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_poor_sv_tracks_no_less_sum_pt_shared_tracks_small_nsv2_nshj1 = fs->make<TH2F>("h_2D_poor_sv_tracks_no_less_sum_pt_shared_tracks_small_nsv2_nshj1", "poor nsv = 2, absdPhi01 <= 0.5, nshj=1, no less_{sum p_{T}} shared tracks; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_poor_sv_tracks_no_less_sum_pt_shared_tracks_small_nsv2_nshj2 = fs->make<TH2F>("h_2D_poor_sv_tracks_no_less_sum_pt_shared_tracks_small_nsv2_nshj2", "poor nsv = 2, absdPhi01 <= 0.5, nshj=2, no less_{sum p_{T}} shared tracks; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_poor_sv_tracks_no_less_sum_pt_shared_tracks_small_nsv2_more_nshj3 = fs->make<TH2F>("h_2D_poor_sv_tracks_no_less_sum_pt_shared_tracks_small_nsv2_more_nshj3", "poor nsv = 2, absdPhi01 <= 0.5, nshj>=3, no less_{sum p_{T}} shared tracks; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);

	h_2D_sv_tracks_no_less_ratio_sum_pt_shared_tracks_small_nsv2 = fs->make<TH2F>("h_2D_sv_tracks_no_less_ratio_sum_pt_shared_tracks_small_nsv2", "nsv = 2, absdPhi01 <= 0.5, no vtx's w/ less_{ratio sum pt} shared tracks ; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_sv_tracks_no_less_ratio_avg_pt_shared_tracks_small_nsv2 = fs->make<TH2F>("h_2D_sv_tracks_no_less_ratio_avg_pt_shared_tracks_small_nsv2", "nsv = 2, absdPhi01 <= 0.5, no vtx's w/ less_{ratio avg pt} shared tracks ; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_sv_tracks_no_less_avg_pt_shared_tracks_small_nsv2 = fs->make<TH2F>("h_2D_sv_tracks_no_less_avg_pt_shared_tracks_small_nsv2", "nsv = 2, absdPhi01 <= 0.5, no vtx's w/ less_{avg pt} shared tracks ; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_poor_sv_tracks_no_less_ratio_sum_pt_shared_tracks_small_nsv2 = fs->make<TH2F>("h_2D_poor_sv_tracks_no_less_ratio_sum_pt_shared_tracks_small_nsv2", "poor nsv = 2, absdPhi01 <= 0.5, no vtx's w/ less_{ratio sum pt} shared tracks ; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_poor_sv_tracks_no_less_ratio_avg_pt_shared_tracks_small_nsv2 = fs->make<TH2F>("h_2D_poor_sv_tracks_no_less_ratio_avg_pt_shared_tracks_small_nsv2", "poor nsv = 2, absdPhi01 <= 0.5, no vtx's w/ less_{ratio avg pt} shared tracks ; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_poor_sv_tracks_no_less_avg_pt_shared_tracks_small_nsv2 = fs->make<TH2F>("h_2D_poor_sv_tracks_no_less_avg_pt_shared_tracks_small_nsv2", "poor nsv = 2, absdPhi01 <= 0.5, no vtx's w/ less_{avg pt} shared tracks ; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	...
	h_svdPhi_nsv2 = fs->make<TH1F>("h_svdPhi_nsv2", "nsv = 2;arb. units", 316, 0, 3.16);
	...
	h_2D_nsharedjets_svdPhi_small_nsv2_shared_jets = fs->make<TH2F>("h_2D_nsharedjets_svdPhi_small_nsv2_shared_jets", "nsv = 2, absdPhi01 <= 0.5; # of shared jets; # abs(deltaphi(sv #0, #1))", 10, 0, 10, 316, 0, 3.16);
	h_2D_nsharedjets_svdPhi_large_nsv2_shared_jets = fs->make<TH2F>("h_2D_nsharedjets_svdPhi_large_nsv2_shared_jets", "nsv = 2, absdPhi01 > 0.5; # of shared jets; # abs(deltaphi(sv #0, #1))", 10, 0, 10, 316, 0, 3.16);
...
void MFVVertexHistos::analyze(const edm::Event & event, const edm::EventSetup&) {
	...
	if (nsv >= 2) {
		...
		if (nsv==2) {
			...
			h_svdPhi_nsv2->Fill(fabs(reco::deltaPhi(phi0, phi1)), w);
			...
			if (fabs(reco::deltaPhi(phi0, phi1)) <= 0.5) {
				...
				if (sv0_track_which_idx.size() >= sv1_track_which_idx.size()) {
					h_2D_sv_tracks_small_nsv2->Fill(sv0_track_which_idx.size(), sv1_track_which_idx.size(), w);
				}
				else {
					h_2D_sv_tracks_small_nsv2->Fill(sv1_track_which_idx.size(), sv0_track_which_idx.size(), w);
		...
		if (shared_jet) {
			...
			if ((nsv == 2) && (fabs(reco::deltaPhi(phi0, phi1)) <= 0.5)) {
				...
				if ((sv0_track_which_idx.size() >= 5) && (sv1_track_which_idx.size() >= 5)) {
					if (sv0_track_which_idx.size() >= sv1_track_which_idx.size()) {
						h_2D_sv_tracks_shared_jets_small_nsv2->Fill(sv0_track_which_idx.size(), sv1_track_which_idx.size(),w);
					}
					else {
						h_2D_sv_tracks_shared_jets_small_nsv2->Fill(sv1_track_which_idx.size(), sv0_track_which_idx.size(),w);
				...
				h_sv_njets_small_nsv2_shj->Fill(njets_sv0, w);
				h_sv_njets_small_nsv2_shj->Fill(njets_sv1, w);
			...
			if (nsv == 2) {	   //start nsv=2
				...
				if (fabs(reco::deltaPhi(phi0, phi1)) <= 0.5) {	//start no split vertex 
					...
					if ((sv0_track_which_idx.size() - sv0_track_which_idx_no_shared_track.size()) >= (sv1_track_which_idx.size() - sv1_track_which_idx_no_shared_track.size())) {		 // sv0 is major vtx
						...
						if ((sv0_track_which_idx_no_shared_track.size() >= 5) && (sv1_track_which_idx_no_shared_track.size() >= 5)) {
							h_2D_sv_tracks_no_shared_tracks_small_nsv2->Fill(sv0_track_which_idx_no_shared_track.size(), sv1_track_which_idx_no_shared_track.size(),w);
						...
						if ((sv1_track_which_idx_no_shared_track.size() >= 5) && (sv0_track_which_idx_no_shared_track.size() >= 5)) {
							h_2D_sv_tracks_no_shared_tracks_small_nsv2->Fill(sv1_track_which_idx_no_shared_track.size(), sv0_track_which_idx_no_shared_track.size(),w);
						}
					...
					if ((sv0_track_which_idx.size()- sv0_track_which_idx_no_shared_track.size()) >= (sv1_track_which_idx.size() - sv1_track_which_idx_no_shared_track.size())) {		 // sv0 is major vtx
						...
						if ((sv0_track_which_idx.size() >= 5) && (sv1_track_which_idx_no_shared_track.size() >= 5)) {
								h_2D_sv_tracks_no_minor_shared_tracks_small_nsv2->Fill(sv0_track_which_idx.size(), sv1_track_which_idx_no_shared_track.size(),w);
						...
						if ((sv1_track_which_idx.size() >= 5) && (sv0_track_which_idx_no_shared_track.size() >= 5)) {	  
								h_2D_sv_tracks_no_minor_shared_tracks_small_nsv2->Fill(sv1_track_which_idx.size(), sv0_track_which_idx_no_shared_track.size(),w);
						}
					...
					h_2D_nsharedjets_svdPhi_small_nsv2_shared_jets->Fill(nsharedjets, fabs(reco::deltaPhi(phi0, phi1)), w);
					...
					int njets_ratio_sum_pT_sv1 = std::set<double>(sv_track_which_jet[1].begin(), sv_track_which_jet[1].end()).size();
						...
						double dphi_small_sv0_sharedjet = double(fabs(reco::deltaPhi(phi0, mevent->jet_phi[jet_index])));
						double dphi_small_sv1_sharedjet = double(fabs(reco::deltaPhi(phi1, mevent->jet_phi[jet_index])));
						...
						h_ratio_ntracks_small_nsv2_shared_jets->Fill(ratio_ntracks_nsv2);
						...
						if (sum_pt_i_sv0 >= sum_pt_i_sv1) {
							h_diff_pT_sum_dPhi_shj_sv_small_nsv2->Fill(dphi_small_sv0_sharedjet, w);
							...
							h_diff_pT_sum_dPhi_shj_sv_small_nsv2->Fill(dphi_small_sv1_sharedjet, w);
						...
						if ((sum_pt_i_sv0/ nsharedjet_tracks_sv0[i]) >= (sum_pt_i_sv1/ nsharedjet_tracks_sv1[i])) {
							h_diff_pT_avg_dPhi_shj_sv_small_nsv2->Fill(dphi_small_sv0_sharedjet, w);
							...
							h_diff_pT_avg_dPhi_shj_sv_small_nsv2->Fill(dphi_small_sv1_sharedjet, w);
						...
						if ((sum_pt_i_sv0 / (sum_pt_i_sv0 + sum_pt_i_no_sv0)) >= (sum_pt_i_sv1 / (sum_pt_i_sv1 + sum_pt_i_no_sv1))) {
							h_diff_ratio_pT_sum_dPhi_shj_sv_small_nsv2->Fill(dphi_small_sv0_sharedjet, w);
							...
							h_diff_ratio_pT_sum_dPhi_shj_sv_small_nsv2->Fill(dphi_small_sv1_sharedjet, w);
						...
						if (((sum_pt_i_sv0* sv0_track_which_idx.size()) /((sum_pt_i_sv0 + sum_pt_i_no_sv0)* nsharedjet_tracks_sv0[i])) >= ((sum_pt_i_sv1* sv1_track_which_idx.size()) /((sum_pt_i_sv1 + sum_pt_i_no_sv1)* nsharedjet_tracks_sv1[i]))) {
							h_diff_ratio_pT_avg_dPhi_shj_sv_small_nsv2->Fill(dphi_small_sv0_sharedjet, w);
							...
							h_diff_ratio_pT_avg_dPhi_shj_sv_small_nsv2->Fill(dphi_small_sv1_sharedjet, w);
					   ...
					   if ((sv0_sum_pt_track_which_idx.size() >= 5) && (sv1_sum_pt_track_which_idx.size() >= 5)) {
							   ...
							   h_2D_sv_tracks_no_less_sum_pt_shared_tracks_small_nsv2->Fill(sv0_sum_pt_track_which_idx.size(), sv1_sum_pt_track_which_idx.size(),w);
							   h_sv_njets_no_less_sum_pt_shared_tracks_small_nsv2->Fill(njets_sum_pT_sv0, w);
							   h_sv_njets_no_less_sum_pt_shared_tracks_small_nsv2->Fill(njets_sum_pT_sv1, w);

					   }
					   else {
							   h_2D_poor_sv_tracks_no_less_sum_pt_shared_tracks_small_nsv2->Fill(sv0_sum_pt_track_which_idx.size(), sv1_sum_pt_track_which_idx.size(),w);
							   h_poor_sv_njets_no_less_sum_pt_shared_tracks_small_nsv2->Fill(njets_sum_pT_sv0, w);
							   h_poor_sv_njets_no_less_sum_pt_shared_tracks_small_nsv2->Fill(njets_sum_pT_sv1, w);
					   }
					   ...
					   if (nsharedjets == 1) {
						   ...
						   if ((sv0_sum_pt_track_which_idx.size() >= 5) && (sv1_sum_pt_track_which_idx.size() >= 5)) {
							   ...
							   h_2D_sv_tracks_no_less_sum_pt_shared_tracks_small_nsv2_nshj1->Fill(sv0_sum_pt_track_which_idx.size(), sv1_sum_pt_track_which_idx.size(),w);

						   }
						   else {
							   h_2D_poor_sv_tracks_no_less_sum_pt_shared_tracks_small_nsv2_nshj1->Fill(sv0_sum_pt_track_which_idx.size(), sv1_sum_pt_track_which_idx.size(),w);
						   }
					   ...
					   if (nsharedjets == 2) {
						   ...
						   if ((sv0_sum_pt_track_which_idx.size() >= 5) && (sv1_sum_pt_track_which_idx.size() >= 5)) {
							   ...
							   h_2D_sv_tracks_no_less_sum_pt_shared_tracks_small_nsv2_nshj2->Fill(sv0_sum_pt_track_which_idx.size(), sv1_sum_pt_track_which_idx.size(),w);

						   }
						   else {
							   h_2D_poor_sv_tracks_no_less_sum_pt_shared_tracks_small_nsv2_nshj2->Fill(sv0_sum_pt_track_which_idx.size(), sv1_sum_pt_track_which_idx.size(),w);
						   }
					   ...
					   if (nsharedjets >= 3) {
						   ...
						   if ((sv0_sum_pt_track_which_idx.size() >= 5) && (sv1_sum_pt_track_which_idx.size() >= 5)) {
							   ...
							   h_2D_sv_tracks_no_less_sum_pt_shared_tracks_small_nsv2_more_nshj3->Fill(sv0_sum_pt_track_which_idx.size(), sv1_sum_pt_track_which_idx.size(),w);

						   }
						   else {
							   h_2D_poor_sv_tracks_no_less_sum_pt_shared_tracks_small_nsv2_more_nshj3->Fill(sv0_sum_pt_track_which_idx.size(), sv1_sum_pt_track_which_idx.size(),w);
						   }
					   ...
					   if ((sv0_ratio_sum_pt_track_which_idx.size() >= 5) && (sv1_ratio_sum_pt_track_which_idx.size() >= 5)) {
						   ...
						   h_2D_sv_tracks_no_less_ratio_sum_pt_shared_tracks_small_nsv2->Fill(sv0_ratio_sum_pt_track_which_idx.size(), sv1_ratio_sum_pt_track_which_idx.size(), w);
						   h_sv_njets_no_less_ratio_sum_pt_shared_tracks_small_nsv2->Fill(njets_ratio_sum_pT_sv0, w);
						   h_sv_njets_no_less_ratio_sum_pt_shared_tracks_small_nsv2->Fill(njets_ratio_sum_pT_sv1, w);
					   }
					   else {
						   h_2D_poor_sv_tracks_no_less_ratio_sum_pt_shared_tracks_small_nsv2->Fill(sv0_ratio_sum_pt_track_which_idx.size(), sv1_ratio_sum_pt_track_which_idx.size(), w);
						   h_poor_sv_njets_no_less_ratio_sum_pt_shared_tracks_small_nsv2->Fill(njets_ratio_sum_pT_sv0, w);
						   h_poor_sv_njets_no_less_ratio_sum_pt_shared_tracks_small_nsv2->Fill(njets_ratio_sum_pT_sv1, w);
					   }

					   if ((sv0_avg_pt_track_which_idx.size() >= 5) && (sv1_avg_pt_track_which_idx.size() >= 5)) {

						   h_2D_sv_tracks_no_less_avg_pt_shared_tracks_small_nsv2->Fill(sv0_avg_pt_track_which_idx.size(), sv1_avg_pt_track_which_idx.size(), w);

					   }
					   else {
						   h_2D_poor_sv_tracks_no_less_avg_pt_shared_tracks_small_nsv2->Fill(sv0_avg_pt_track_which_idx.size(), sv1_avg_pt_track_which_idx.size(), w);
					   }

					   if ((sv0_ratio_avg_pt_track_which_idx.size() >= 5) && (sv1_ratio_avg_pt_track_which_idx.size() >= 5)) {

						   h_2D_sv_tracks_no_less_ratio_avg_pt_shared_tracks_small_nsv2->Fill(sv0_ratio_avg_pt_track_which_idx.size(), sv1_ratio_avg_pt_track_which_idx.size(), w);

					   }
					   else {
						   h_2D_poor_sv_tracks_no_less_ratio_avg_pt_shared_tracks_small_nsv2->Fill(sv0_ratio_avg_pt_track_which_idx.size(), sv1_ratio_avg_pt_track_which_idx.size(), w);
					   }
				...
				h_2D_nsharedjets_svdPhi_large_nsv2_shared_jets->Fill(nsharedjets, fabs(reco::deltaPhi(phi0, phi1)), w);
				}
		...
		if (nsv == 2) {
			...
			if (fabs(reco::deltaPhi(phi0, phi1)) <= 0.5){
				int njets_sv0 = std::set<double>(sv_track_which_jet[0].begin(), sv_track_which_jet[0].end()).size();
				int njets_sv1 = std::set<double>(sv_track_which_jet[1].begin(), sv_track_which_jet[1].end()).size();
				h_sv_njets_small_nsv2_no_shj->Fill(njets_sv0, w);
				h_sv_njets_small_nsv2_no_shj->Fill(njets_sv1, w);
				h_ratio_diff_pT_sum_sv_nsv2_small_no_shj->Fill((sum_pt_sv0 - sum_pt_sv1) / (sum_pt_sv0 + sum_pt_sv1), w);
				if (sv0_track_which_idx.size() >= sv1_track_which_idx.size()) {
					h_ratio_diff_pT_sum_major_minor_sv_nsv2_small_no_shj->Fill((sum_pt_sv0 - sum_pt_sv1) / (sum_pt_sv0 + sum_pt_sv1), w);
				}
				else {
					h_ratio_diff_pT_sum_major_minor_sv_nsv2_small_no_shj->Fill((sum_pt_sv1 - sum_pt_sv0) / (sum_pt_sv1 + sum_pt_sv0), w);

				}

				h_nsharedjets_small_nsv2_shared_jets->Fill((int)0, w);
				h_2D_nsharedjets_svdist3d_small_nsv2_shared_jets->Fill((int)0, svdist3d, w);
				h_2D_nsharedjets_svdPhi_small_nsv2_shared_jets->Fill((int)0, fabs(reco::deltaPhi(phi0, phi1)), w);

			}
			else {
				h_2D_nsharedjets_svdist3d_large_nsv2_shared_jets->Fill((int)0, svdist3d, w);
				h_2D_nsharedjets_svdPhi_large_nsv2_shared_jets->Fill((int)0, fabs(reco::deltaPhi(phi0, phi1)), w);
			}
