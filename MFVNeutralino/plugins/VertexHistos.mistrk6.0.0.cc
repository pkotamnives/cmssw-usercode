...
private:
	...
	TH1F* h_diff_pT_avg_major_minor_sv_nsv2_all_fig2;
	TH1F* h_diff_ratio_pT_avg_major_minor_sv_nsv2_all_fig2;
	TH1F* h_diff_pT_sum_major_minor_sv_nsv2_all_fig2;
	TH1F* h_diff_ratio_pT_sum_major_minor_sv_nsv2_all_fig2;
	TH1F* h_ratio_diff_pT_sum_major_minor_sv_nsv2_all_fig2;
	TH1F* h_ratio_diff_pT_avg_major_minor_sv_nsv2_all_fig2;
	...
	do_scatterplots(cfg.getParameter<bool>("do_scatterplots"))
{
	...
	h_2D_sv_tracks_no_minor_shared_tracks_large_nsv2 = fs->make<TH2F>("h_2D_sv_tracks_no_minor_shared_tracks_large_nsv2", "nsv = 2, absdPhi01 > 0.5, no sv1 tracks;  # major vtx's tracks; # minor vtx's tracks", 50, 0, 50, 50, 0, 50);

	h_2D_sv_tracks_shared_jets_nshj1_large_nsv2 = fs->make<TH2F>("h_2D_sv_tracks_shared_jets_nshj1_large_nsv2", "nsv = 2, absdPhi01 > 0.5, nshj=1; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_sv_tracks_no_shared_tracks_nshj1_large_nsv2 = fs->make<TH2F>("h_2D_sv_tracks_no_shared_tracks_nshj1_large_nsv2", "nsv = 2, absdPhi01 > 0.5, nshj=1, no shared tracks; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_sv_tracks_no_minor_shared_tracks_nshj1_large_nsv2 = fs->make<TH2F>("h_2D_sv_tracks_no_minor_shared_tracks_nshj1_large_nsv2", "nsv = 2, absdPhi01 > 0.5, nshj=1, no sv1 vtx's shared tracks; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_sv_tracks_no_less_ratio_sum_pt_shared_tracks_nshj1_large_nsv2 = fs->make<TH2F>("h_2D_sv_tracks_no_less_ratio_sum_pt_shared_tracks_nshj1_large_nsv2", "nsv = 2, absdPhi01 > 0.5, nshj=1, no vtx's w/ less_{ratio sum pt} shared tracks ; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_sv_tracks_no_less_ratio_avg_pt_shared_tracks_nshj1_large_nsv2 = fs->make<TH2F>("h_2D_sv_tracks_no_less_ratio_avg_pt_shared_tracks_nshj1_large_nsv2", "nsv = 2, absdPhi01 > 0.5, nshj=1, no vtx's w/ less_{ratio avg pt} shared tracks ; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_sv_tracks_no_less_avg_pt_shared_tracks_nshj1_large_nsv2 = fs->make<TH2F>("h_2D_sv_tracks_no_less_avg_pt_shared_tracks_nshj1_large_nsv2", "nsv = 2, absdPhi01 > 0.5, nshj=1, no vtx's w/ less_{avg pt} shared tracks ; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_sv_tracks_no_less_sum_pt_shared_tracks_nshj1_large_nsv2 = fs->make<TH2F>("h_2D_sv_tracks_no_less_sum_pt_shared_tracks_nshj1_large_nsv2", "nsv = 2, absdPhi01 > 0.5, nshj=1, no vtx's w/ less_{sum pt} shared tracks ; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_sv_tracks_no_minor_less_ratio_sum_pt_shared_tracks_nshj1_large_nsv2 = fs->make<TH2F>("h_2D_sv_tracks_no_minor_less_ratio_sum_pt_shared_tracks_nshj1_large_nsv2", "nsv = 2, absdPhi01 > 0.5, nshj=1, no sv1 vtx's w/ less_{ratio sum pt} shared tracks ; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_sv_tracks_no_minor_less_ratio_avg_pt_shared_tracks_nshj1_large_nsv2 = fs->make<TH2F>("h_2D_sv_tracks_no_minor_less_ratio_avg_pt_shared_tracks_nshj1_large_nsv2", "nsv = 2, absdPhi01 > 0.5, nshj=1, no sv1 vtx's w/ less_{ratio avg pt} shared tracks ; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_sv_tracks_no_minor_less_avg_pt_shared_tracks_nshj1_large_nsv2 = fs->make<TH2F>("h_2D_sv_tracks_no_minor_less_avg_pt_shared_tracks_nshj1_large_nsv2", "nsv = 2, absdPhi01 > 0.5, nshj=1, no sv1 vtx's w/ less_{avg pt} shared tracks ; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_sv_tracks_no_minor_less_sum_pt_shared_tracks_nshj1_large_nsv2 = fs->make<TH2F>("h_2D_sv_tracks_no_minor_less_sum_pt_shared_tracks_nshj1_large_nsv2", "nsv = 2, absdPhi01 > 0.5, nshj=1, no sv1 vtx's w/ less_{sum pt} shared tracks ; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	
	h_2D_poor_sv_tracks_shared_jets_nshj1_large_nsv2 = fs->make<TH2F>("h_2D_poor_sv_tracks_shared_jets_nshj1_large_nsv2", "poor nsv = 2, absdPhi01 > 0.5, nshj=1; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_poor_sv_tracks_no_shared_tracks_nshj1_large_nsv2 = fs->make<TH2F>("h_2D_poor_sv_tracks_no_shared_tracks_nshj1_large_nsv2", "poor nsv = 2, absdPhi01 > 0.5, nshj=1, no shared tracks; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_poor_sv_tracks_no_minor_shared_tracks_nshj1_large_nsv2 = fs->make<TH2F>("h_2D_poor_sv_tracks_no_minor_shared_tracks_nshj1_large_nsv2", "poor nsv = 2, absdPhi01 > 0.5, nshj=1, no sv1 vtx's shared tracks; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_poor_sv_tracks_no_less_ratio_sum_pt_shared_tracks_nshj1_large_nsv2 = fs->make<TH2F>("h_2D_poor_sv_tracks_no_less_ratio_sum_pt_shared_tracks_nshj1_large_nsv2", "poor nsv = 2, absdPhi01 > 0.5, nshj=1, no vtx's w/ less_{ratio sum pt} shared tracks ; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_poor_sv_tracks_no_less_ratio_avg_pt_shared_tracks_nshj1_large_nsv2 = fs->make<TH2F>("h_2D_poor_sv_tracks_no_less_ratio_avg_pt_shared_tracks_nshj1_large_nsv2", "poor nsv = 2, absdPhi01 > 0.5, nshj=1, no vtx's w/ less_{ratio avg pt} shared tracks ; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_poor_sv_tracks_no_less_avg_pt_shared_tracks_nshj1_large_nsv2 = fs->make<TH2F>("h_2D_poor_sv_tracks_no_less_avg_pt_shared_tracks_nshj1_large_nsv2", "poor nsv = 2, absdPhi01 > 0.5, nshj=1, no vtx's w/ less_{avg pt} shared tracks ; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_poor_sv_tracks_no_less_sum_pt_shared_tracks_nshj1_large_nsv2 = fs->make<TH2F>("h_2D_poor_sv_tracks_no_less_sum_pt_shared_tracks_nshj1_large_nsv2", "poor nsv = 2, absdPhi01 > 0.5, nshj=1, no vtx's w/ less_{sum pt} shared tracks ; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_poor_sv_tracks_no_minor_less_ratio_sum_pt_shared_tracks_nshj1_large_nsv2 = fs->make<TH2F>("h_2D_poor_sv_tracks_no_minor_less_ratio_sum_pt_shared_tracks_nshj1_large_nsv2", "poor nsv = 2, absdPhi01 > 0.5, nshj=1, no sv1 vtx's w/ less_{ratio sum pt} shared tracks ; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_poor_sv_tracks_no_minor_less_ratio_avg_pt_shared_tracks_nshj1_large_nsv2 = fs->make<TH2F>("h_2D_poor_sv_tracks_no_minor_less_ratio_avg_pt_shared_tracks_nshj1_large_nsv2", "poor nsv = 2, absdPhi01 > 0.5, nshj=1, no sv1 vtx's w/ less_{ratio avg pt} shared tracks ; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_poor_sv_tracks_no_minor_less_avg_pt_shared_tracks_nshj1_large_nsv2 = fs->make<TH2F>("h_2D_poor_sv_tracks_no_minor_less_avg_pt_shared_tracks_nshj1_large_nsv2", "poor nsv = 2, absdPhi01 > 0.5, nshj=1, no sv1 vtx's w/ less_{avg pt} shared tracks ; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	h_2D_poor_sv_tracks_no_minor_less_sum_pt_shared_tracks_nshj1_large_nsv2 = fs->make<TH2F>("h_2D_poor_sv_tracks_no_minor_less_sum_pt_shared_tracks_nshj1_large_nsv2", "poor nsv = 2, absdPhi01 > 0.5, nshj=1, no sv1 vtx's w/ less_{sum pt} shared tracks ; # sv0 vtx's tracks; # sv1 vtx's tracks", 50, 0, 50, 50, 0, 50);
	...
	h_diff_pT_avg_major_minor_sv_nsv2_all_fig2 = fs->make<TH1F>("h_diff_pT_avg_major_minor_sv_nsv2_all_fig2", "nsv = 2, absdeltaphi01 > 0.5, shared ratios = 1; sv0 shared avg p_{T} - sv1 shared avg p_{T}", 200, -100, 100);
	h_diff_ratio_pT_avg_major_minor_sv_nsv2_all_fig2 = fs->make<TH1F>("h_diff_ratio_pT_avg_major_minor_sv_nsv2_all_fig2", "nsv = 2, absdeltaphi01 > 0.5, shared ratios = 1; sv0 ratio - sv1 ratio (shared avg p_{T}/SV all avg p_{T})", 40, -2, 2);
	h_diff_pT_sum_major_minor_sv_nsv2_all_fig2 = fs->make<TH1F>("h_diff_pT_sum_major_minor_sv_nsv2_all_fig2", "nsv = 2, absdeltaphi01 > 0.5, shared ratios = 1; sv0 shared sum p_{T} - sv1 shared sum p_{T}", 200, -1000, 1000);
	h_diff_ratio_pT_sum_major_minor_sv_nsv2_all_fig2 = fs->make<TH1F>("h_diff_ratio_pT_sum_major_minor_sv_nsv2_all_fig2", "nsv = 2, absdeltaphi01 > 0.5, shared ratios = 1; sv0 ratio - sv1 ratio (shared sum p_{T}/SV all sum p_{T})", 40, -2, 2);
	h_ratio_diff_pT_sum_major_minor_sv_nsv2_all_fig2 = fs->make<TH1F>("h_ratio_diff_pT_sum_major_minor_sv_nsv2_all_fig2", "nsv = 2, absdeltaphi01 > 0.5, shared ratios = 1; #frac{sv0 shared sum pT - sv1 shared sum pT}{sv0 shared sum pT + sv1 shared sum pT}", 40, -2, 2);
	h_ratio_diff_pT_avg_major_minor_sv_nsv2_all_fig2 = fs->make<TH1F>("h_ratio_diff_pT_avg_major_minor_sv_nsv2_all_fig2", "nsv = 2, absdeltaphi01 > 0.5, shared ratios = 1; #frac{sv0 shared avg pT - sv1 shared avg pT}{sv0 shared avg pT + sv1 shared avg pT}", 40, -2, 2);
