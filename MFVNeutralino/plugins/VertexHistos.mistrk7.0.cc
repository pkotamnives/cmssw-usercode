			...
			if (nsv == 2) {	   //start nsv=2
				...
				if (fabs(reco::deltaPhi(phi0, phi1)) > 0.5) {	//start no split vertex 
					...
					std::vector<int> sv1_sum_pt_track_which_idx = sv1_track_which_idx;
						...
						for (unsigned int j = 0; j < nsharedjet_tracks_sv0[i]; j++) {
							idx = sv0_i_sharedjet_which_idx[j];
						...
						for (unsigned int j = 0; j < nsharedjet_tracks_sv1[i]; j++) {
							idx = sv1_i_sharedjet_which_idx[j];
...
h_more_pT_sig_avg_major_sv_nsv2_semi_fig2->Fill(int(0), w);
					   ...
					   if ((sv0_sum_pt_track_which_idx.size() >= 5) && (sv1_sum_pt_track_which_idx.size() >= 5)) {
							   ...
							   h_2D_sv_tracks_no_less_sum_pt_shared_tracks_large_nsv2->Fill(sv0_sum_pt_track_which_idx.size(), sv1_sum_pt_track_which_idx.size());

					   }
					   else {
							   h_2D_poor_sv_tracks_no_less_sum_pt_shared_tracks_large_nsv2->Fill(sv0_sum_pt_track_which_idx.size(), sv1_sum_pt_track_which_idx.size());
					   }
					   ...
					   if (nsharedjets == 1) {
						   ...
						   if ((sv0_sum_pt_track_which_idx.size() >= 5) && (sv1_sum_pt_track_which_idx.size() >= 5)) {
							   ...
							   h_2D_sv_tracks_no_less_sum_pt_shared_tracks_large_nsv2_nshj1->Fill(sv0_sum_pt_track_which_idx.size(), sv1_sum_pt_track_which_idx.size());

						   }
						   else {
							   h_2D_poor_sv_tracks_no_less_sum_pt_shared_tracks_large_nsv2_nshj1->Fill(sv0_sum_pt_track_which_idx.size(), sv1_sum_pt_track_which_idx.size());
						   }
					   ...
					   if (nsharedjets == 2) {
						   ...
						   if ((sv0_sum_pt_track_which_idx.size() >= 5) && (sv1_sum_pt_track_which_idx.size() >= 5)) {
							   ...
							   h_2D_sv_tracks_no_less_sum_pt_shared_tracks_large_nsv2_nshj2->Fill(sv0_sum_pt_track_which_idx.size(), sv1_sum_pt_track_which_idx.size());

						   }
						   else {
							   h_2D_poor_sv_tracks_no_less_sum_pt_shared_tracks_large_nsv2_nshj2->Fill(sv0_sum_pt_track_which_idx.size(), sv1_sum_pt_track_which_idx.size());
						   }
					   ...
					   if (nsharedjets >= 3) {
						   ...
						   if ((sv0_sum_pt_track_which_idx.size() >= 5) && (sv1_sum_pt_track_which_idx.size() >= 5)) {
							   ...
							   h_2D_sv_tracks_no_less_sum_pt_shared_tracks_large_nsv2_more_nshj3->Fill(sv0_sum_pt_track_which_idx.size(), sv1_sum_pt_track_which_idx.size());

						   }
						   else {
							   h_2D_poor_sv_tracks_no_less_sum_pt_shared_tracks_large_nsv2_more_nshj3->Fill(sv0_sum_pt_track_which_idx.size(), sv1_sum_pt_track_which_idx.size());
						   }
