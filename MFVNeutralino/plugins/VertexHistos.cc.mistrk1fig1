...
private:
	...
	TH1F* h_max_absdeltaphi0_large_nsv2_shared_tracks_fig1;
	TH1F* h_max_absdeltaphi1_large_nsv2_shared_tracks_fig1;
	TH1F* h_max_pt_absdeltaphi0_large_sv_shared_tracks_fig1;
	TH1F* h_max_pt_absdeltaphi1_large_sv_shared_tracks_fig1;
	TH1F* h_miss_dist_absdeltaphi0_large_other_sv_shared_tracks_fig1;
	TH1F* h_miss_dist_absdeltaphi1_large_other_sv_shared_tracks_fig1;
	TH1F* h_miss_dist_absdeltaphi0_large_its_sv_shared_tracks_fig1;
	TH1F* h_miss_dist_absdeltaphi1_large_its_sv_shared_tracks_fig1;
	TH1F* h_miss_dist_err_absdeltaphi0_large_other_sv_shared_tracks_fig1;
	TH1F* h_miss_dist_err_absdeltaphi1_large_other_sv_shared_tracks_fig1;
	TH1F* h_miss_dist_err_absdeltaphi0_large_its_sv_shared_tracks_fig1;
	TH1F* h_miss_dist_err_absdeltaphi1_large_its_sv_shared_tracks_fig1;
	TH1F* h_miss_dist_2D_absdeltaphi0_large_other_sv_shared_tracks_fig1;
	TH1F* h_miss_dist_2D_absdeltaphi1_large_other_sv_shared_tracks_fig1;
	TH1F* h_miss_dist_2D_absdeltaphi0_large_its_sv_shared_tracks_fig1;
	TH1F* h_miss_dist_2D_absdeltaphi1_large_its_sv_shared_tracks_fig1;
	TH1F* h_miss_dist_sig_absdeltaphi0_large_other_sv_shared_tracks_fig1;
	TH1F* h_miss_dist_sig_absdeltaphi1_large_other_sv_shared_tracks_fig1;
	TH1F* h_miss_dist_sig_absdeltaphi0_large_its_sv_shared_tracks_fig1;
	TH1F* h_miss_dist_sig_absdeltaphi1_large_its_sv_shared_tracks_fig1;
	TH1F* h_vertex_chi2dof_absdeltaphi0_large_nsv2_fig1;
	TH1F* h_absdeltaphi_large_jet_shared_tracks_nsv2_fig1;
	TH1F* h_pt_poor_shared_tracks_large_nsv2_fig1;
	TH1F* h_pt_good_shared_tracks_large_nsv2_fig1;
	TH1F* h_dxy_poor_shared_tracks_large_nsv2_fig1;
	TH1F* h_dxy_good_shared_tracks_large_nsv2_fig1;
	TH1F* h_ratio_ntracks_large_nsv2_shared_jets_fig1;
	TH1F* h_max_absdeltaphi1_large_sv_shared_jets_fig1;
	TH1F* h_max_absdeltaphi0_large_sv_shared_jets_fig1;
	TH1F* h_max_absdeltaphi1_large_sv_shared_tracks_fig1;
	TH1F* h_max_absdeltaphi0_large_sv_shared_tracks_fig1;
	TH2F* h_2D_miss_dist_phi_absdeltaphi0_large_sv_fig1;
	TH2F* h_2D_miss_dist_phi_absdeltaphi1_large_sv_fig1;
	TH2F* h_2D_pt_dxy_absdeltaphi0_large_sv_fig1;
	TH2F* h_2D_pt_dxy_absdeltaphi1_large_sv_fig1;
	...
	do_scatterplots(cfg.getParameter<bool>("do_scatterplots"))
{
	...
	h_max_absdeltaphi0_large_sv_shared_jets_fig1 = fs->make<TH1F>("h_max_absdeltaphi0_large_sv_shared_jets_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1;max(dphi(each SV, each shared jet));arb. units", 316, 0, 3.16);
	h_max_absdeltaphi1_large_sv_shared_jets_fig1 = fs->make<TH1F>("h_max_absdeltaphi1_large_sv_shared_jets_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1;min(dphi(each SV, each shared jet));arb. units", 316, 0, 3.16);
	h_max_absdeltaphi0_large_sv_shared_tracks_fig1 = fs->make<TH1F>("h_max_absdeltaphi0_large_sv_shared_tracks_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1;delta(phi of max track, phi of its vertex);arb. units", 316, 0, 3.16);
	h_max_absdeltaphi1_large_sv_shared_tracks_fig1 = fs->make<TH1F>("h_max_absdeltaphi1_large_sv_shared_tracks_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1;delta(phi of min track, phi of its vertex);arb. units", 316, 0, 3.16);
	h_max_pt_absdeltaphi0_large_sv_shared_tracks_fig1 = fs->make<TH1F>("h_max_pt_absdeltaphi0_large_sv_shared_tracks_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1; max track p_{T} (GeV);arb. units", 200, 0, 200);
	h_max_pt_absdeltaphi1_large_sv_shared_tracks_fig1 = fs->make<TH1F>("h_max_pt_absdeltaphi1_large_sv_shared_tracks_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1; min track p_{T} (GeV);arb. units", 200, 0, 200);
	h_miss_dist_absdeltaphi0_large_other_sv_shared_tracks_fig1 = fs->make<TH1F>("h_miss_dist_absdeltaphi0_large_other_sv_shared_tracks_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1;miss distance(max track, another vertex) (cm);arb. units", 200, 0, 2.0);
	h_miss_dist_absdeltaphi1_large_other_sv_shared_tracks_fig1 = fs->make<TH1F>("h_miss_dist_absdeltaphi1_large_other_sv_shared_tracks_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1;miss distance(min track, another vertex) (cm);arb. units", 200, 0, 2.0);
	h_miss_dist_absdeltaphi0_large_its_sv_shared_tracks_fig1 = fs->make<TH1F>("h_miss_dist_absdeltaphi0_large_its_sv_shared_tracks_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1;miss distance(max track, its vertex) (cm);arb. units", 100, 0, 0.5);
	h_miss_dist_absdeltaphi1_large_its_sv_shared_tracks_fig1 = fs->make<TH1F>("h_miss_dist_absdeltaphi1_large_its_sv_shared_tracks_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1;miss distance(min track, its vertex) (cm);arb. units", 100, 0, 0.5);
	h_miss_dist_err_absdeltaphi0_large_other_sv_shared_tracks_fig1 = fs->make<TH1F>("h_miss_dist_err_absdeltaphi0_large_other_sv_shared_tracks_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1;miss distance err(max track, another vertex) (cm);arb. units", 100, 0, 0.1);
	h_miss_dist_err_absdeltaphi1_large_other_sv_shared_tracks_fig1 = fs->make<TH1F>("h_miss_dist_err_absdeltaphi1_large_other_sv_shared_tracks_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1;miss distance err(min track, another vertex) (cm);arb. units", 100, 0, 0.1);
	h_miss_dist_err_absdeltaphi0_large_its_sv_shared_tracks_fig1 = fs->make<TH1F>("h_miss_dist_err_absdeltaphi0_large_its_sv_shared_tracks_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1;miss distance err(max track, its vertex) (cm);arb. units", 100, 0, 0.1);
	h_miss_dist_err_absdeltaphi1_large_its_sv_shared_tracks_fig1 = fs->make<TH1F>("h_miss_dist_err_absdeltaphi1_large_its_sv_shared_tracks_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1;miss distance err(min track, its vertex) (cm);arb. units", 100, 0, 0.1);
	h_miss_dist_2D_absdeltaphi0_large_other_sv_shared_tracks_fig1 = fs->make<TH1F>("h_miss_dist_2D_absdeltaphi0_large_other_sv_shared_tracks_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1;miss distance 2D(max track, another vertex) (cm);arb. units", 100, 0, 0.5);
	h_miss_dist_2D_absdeltaphi1_large_other_sv_shared_tracks_fig1 = fs->make<TH1F>("h_miss_dist_2D_absdeltaphi1_large_other_sv_shared_tracks_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1;miss distance 2D(min track, another vertex) (cm);arb. units", 100, 0, 0.5);
	h_miss_dist_2D_absdeltaphi0_large_its_sv_shared_tracks_fig1 = fs->make<TH1F>("h_miss_dist_2D_absdeltaphi0_large_its_sv_shared_tracks_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1;miss distance 2D(max track, its vertex) (cm);arb. units", 100, 0, 0.5);
	h_miss_dist_2D_absdeltaphi1_large_its_sv_shared_tracks_fig1 = fs->make<TH1F>("h_miss_dist_2D_absdeltaphi1_large_its_sv_shared_tracks_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1;miss distance 2D(min track, its vertex) (cm);arb. units", 100, 0, 0.5);
	h_miss_dist_sig_absdeltaphi0_large_other_sv_shared_tracks_fig1 = fs->make<TH1F>("h_miss_dist_sig_absdeltaphi0_large_other_sv_shared_tracks_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1;miss distance sig(max track, another vertex);arb. units", 200, 0, 20);
	h_miss_dist_sig_absdeltaphi1_large_other_sv_shared_tracks_fig1 = fs->make<TH1F>("h_miss_dist_sig_absdeltaphi1_large_other_sv_shared_tracks_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1;miss distance sig(min track, another vertex);arb. units", 200, 0, 20);
	h_miss_dist_sig_absdeltaphi0_large_its_sv_shared_tracks_fig1 = fs->make<TH1F>("h_miss_dist_sig_absdeltaphi0_large_its_sv_shared_tracks_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1;miss distance sig(max track, its vertex);arb. units", 100, 0, 10);
	h_miss_dist_sig_absdeltaphi1_large_its_sv_shared_tracks_fig1 = fs->make<TH1F>("h_miss_dist_sig_absdeltaphi1_large_its_sv_shared_tracks_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1;miss distance sig(min track, its vertex);arb. units", 100, 0, 10);
	h_vertex_chi2dof_absdeltaphi0_large_nsv2_fig1 = fs->make<TH1F>("h_vertex_chi2dof_absdeltaphi0_large_nsv2_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1; sv opposite to the shared jet's tracks #chi^ { 2 } / dof ;arb. units", 100, 0, 10);
	h_absdeltaphi_large_jet_shared_tracks_nsv2_fig1 = fs->make<TH1F>("h_absdeltaphi_large_jet_shared_tracks_nsv2_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1; abs(delta(shared tracks, phi of the only-one shared jet));arb. units", 316, 0, 3.16);
	h_ratio_ntracks_large_nsv2_shared_jets_fig1 = fs->make<TH1F>("h_ratio_ntracks_large_nsv2_shared_jets_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1;ratios of shared tracks (>=1);arb. units", 50, 0, 10);
	h_2D_miss_dist_phi_absdeltaphi0_large_sv_fig1 = fs->make<TH2F>("h_2D_miss_dist_phi_absdeltaphi0_large_sv_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1;miss distance(max track, another vertex) (cm);delta(phi of max track, phi of its vertex)", 100, 0, 0.5, 316, 0, 3.16);
	h_2D_miss_dist_phi_absdeltaphi1_large_sv_fig1 = fs->make<TH2F>("h_2D_miss_dist_phi_absdeltaphi1_large_sv_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1;miss distance(min track, another vertex) (cm);delta(phi of min track, phi of its vertex)", 100, 0, 0.5, 316, 0, 3.16);
	h_2D_pt_dxy_absdeltaphi0_large_sv_fig1 = fs->make<TH2F>("h_2D_pt_dxy_absdeltaphi0_large_sv_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1;max track p_{T} (GeV);max track d_{xy} (cm)", 100, 0, 100, 100, 0, 0.1);
	h_2D_pt_dxy_absdeltaphi1_large_sv_fig1 = fs->make<TH2F>("h_2D_pt_dxy_absdeltaphi1_large_sv_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1;min track p_{T} (GeV);min track d_{xy} (cm)", 100, 0, 100, 100, 0, 0.1);
	h_pt_poor_shared_tracks_large_nsv2_fig1 = fs->make<TH1F>("h_pt_poor_shared_tracks_large_nsv2_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1; max track p_{T} (GeV);arb. units", 100, 0, 100);
	h_pt_good_shared_tracks_large_nsv2_fig1 = fs->make<TH1F>("h_pt_good_shared_tracks_large_nsv2_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1; min track p_{T} (GeV);arb. units", 100, 0, 100);
	h_dxy_poor_shared_tracks_large_nsv2_fig1 = fs->make<TH1F>("h_dxy_poor_shared_tracks_large_nsv2_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1; max track d_{xy} (cm);arb. units", 100, 0, 0.1);
	h_dxy_good_shared_tracks_large_nsv2_fig1 = fs->make<TH1F>("h_dxy_good_shared_tracks_large_nsv2_fig1", "nsv = 2, absdeltaphi01 > 0.5, fig1; min track d_{xy} (cm);arb. units", 100, 0, 0.1);
					...
					for (int i = 0; i < nsharedjets; i++) {
						...
						if (ratio_ntracks_nsv2 >= 4) {		// study sample with all sh jets
							...
							if ((dphi_large_sv0_sharedjet > dphi_large_sv1_sharedjet) && (nsharedjet_tracks_sv0[i] < nsharedjet_tracks_sv1[i])) {
								...
								if ((miss_dist_max.value() < 0.025) && (miss_dist_min.value() < 0.025)) {		 // fig1

									h_max_absdeltaphi0_large_sv_shared_jets_fig1->Fill(dphi_large_sv0_sharedjet, w);
									h_max_absdeltaphi1_large_sv_shared_jets_fig1->Fill(dphi_large_sv1_sharedjet, w);

									double ratio_ntracks_nsv2_fig1 = nsharedjet_tracks_sv1[i]/nsharedjet_tracks_sv0[i] ;
									h_ratio_ntracks_large_nsv2_shared_jets_fig1->Fill(ratio_ntracks_nsv2_fig1);
									...
									for (int j = 0; j < nsharedjet_tracks_sv1[i]; j++) {
										...
										double absdelta_min_sv1_track = double(fabs(reco::deltaPhi(mevent->jet_phi[jet_index], sv1.track_phi[track_idx]))); //phi1
										double absdelta_jet_track = double(fabs(reco::deltaPhi(mevent->jet_phi[jet_index], sv1.track_phi[track_idx])));
										h_absdeltaphi_large_jet_shared_tracks_nsv2_fig1->Fill(absdelta_jet_track, w);
										h_pt_good_shared_tracks_large_nsv2_fig1->Fill(sv1.track_pt(track_idx), w);
										h_dxy_good_shared_tracks_large_nsv2_fig1->Fill(sv1.track_dxy[track_idx], w);
										std::cout << "sv0>sv1 : phi1 is " << phi1 << " with track phi " << sv1.track_phi[track_idx] << ", deltaPhi(jet,trk) is " << double(fabs(reco::deltaPhi(mevent->jet_phi[jet_index], sv1.track_phi[track_idx]))) << std::endl;
										absdeltaphi_min_sv1_shared_tracks.push_back(absdelta_min_sv1_track);
									}
									double min_dphi_sv1_track = *std::min_element(absdeltaphi_min_sv1_shared_tracks.begin(), absdeltaphi_min_sv1_shared_tracks.end());
									...
									int min_sv1_track_idx = sv1_nsharedjets1_which_idx[min_dphi_sv1_track_idx];
									h_max_absdeltaphi1_large_sv_shared_tracks_fig1->Fill(double(fabs(reco::deltaPhi(phi1, sv1.track_phi[min_sv1_track_idx]))), w);
									h_max_pt_absdeltaphi1_large_sv_shared_tracks_fig1->Fill(sv1.track_pt(min_sv1_track_idx), w);
									...
									for (int j = 0; j < nsharedjet_tracks_sv0[i]; j++) {
										int track_idx = sv0_nsharedjets1_which_idx[j];
										double absdelta_max_sv0_track = double(fabs(reco::deltaPhi(mevent->jet_phi[jet_index], sv0.track_phi[track_idx]))); //phi0
										double absdelta_jet_track = double(fabs(reco::deltaPhi(mevent->jet_phi[jet_index], sv0.track_phi[track_idx])));                                                                     h_absdeltaphi_large_jet_shared_tracks_nsv2_fig1->Fill(absdelta_jet_track, w);
										h_pt_poor_shared_tracks_large_nsv2_fig1->Fill(sv0.track_pt(track_idx), w);
										h_dxy_poor_shared_tracks_large_nsv2_fig1->Fill(sv0.track_dxy[track_idx], w);
										std::cout << "sv0>sv1 : phi0 is " << phi0 << " with track phi " << sv0.track_phi[track_idx] << ", deltaPhi(jet,trk) is " << double(fabs(reco::deltaPhi(mevent->jet_phi[jet_index], sv0.track_phi[track_idx]))) << std::endl;
										absdeltaphi_max_sv0_shared_tracks.push_back(absdelta_max_sv0_track);
									}
									double max_dphi_sv0_track = *std::max_element(absdeltaphi_max_sv0_shared_tracks.begin(), absdeltaphi_max_sv0_shared_tracks.end());
									...
									int max_sv0_track_idx = sv0_nsharedjets1_which_idx[max_dphi_sv0_track_idx];
									h_max_absdeltaphi0_large_sv_shared_tracks_fig1->Fill(double(fabs(reco::deltaPhi(phi0, sv0.track_phi[max_sv0_track_idx]))), w);
									h_max_pt_absdeltaphi0_large_sv_shared_tracks_fig1->Fill(sv0.track_pt(max_sv0_track_idx), w);
									...
									h_miss_dist_absdeltaphi0_large_other_sv_shared_tracks_fig1->Fill(miss_dist_max.value(), w);
									h_miss_dist_err_absdeltaphi0_large_other_sv_shared_tracks_fig1->Fill(miss_dist_max.error(), w);
									h_miss_dist_2D_absdeltaphi0_large_other_sv_shared_tracks_fig1->Fill(miss_dist_2D_max.value(), w);
									h_miss_dist_sig_absdeltaphi0_large_other_sv_shared_tracks_fig1->Fill(miss_dist_max.significance(), w);
							
									h_miss_dist_absdeltaphi1_large_other_sv_shared_tracks_fig1->Fill(miss_dist_min.value(), w);
									h_miss_dist_err_absdeltaphi1_large_other_sv_shared_tracks_fig1->Fill(miss_dist_min.error(), w);
									h_miss_dist_2D_absdeltaphi1_large_other_sv_shared_tracks_fig1->Fill(miss_dist_2D_min.value(), w);
									h_miss_dist_sig_absdeltaphi1_large_other_sv_shared_tracks_fig1->Fill(miss_dist_min.significance(), w);

								
									h_miss_dist_absdeltaphi0_large_its_sv_shared_tracks_fig1->Fill(miss_dist_max_own.value(), w);
									h_miss_dist_err_absdeltaphi0_large_its_sv_shared_tracks_fig1->Fill(miss_dist_max_own.error(), w);
									h_miss_dist_2D_absdeltaphi0_large_its_sv_shared_tracks_fig1->Fill(miss_dist_2D_max_own.value(), w);
									h_miss_dist_sig_absdeltaphi0_large_its_sv_shared_tracks_fig1->Fill(miss_dist_max_own.significance(), w);
									
									h_miss_dist_absdeltaphi1_large_its_sv_shared_tracks_fig1->Fill(miss_dist_min_own.value(), w);
									h_miss_dist_err_absdeltaphi1_large_its_sv_shared_tracks_fig1->Fill(miss_dist_min_own.error(), w);
									h_miss_dist_2D_absdeltaphi1_large_its_sv_shared_tracks_fig1->Fill(miss_dist_2D_min_own.value(), w);
									h_miss_dist_sig_absdeltaphi1_large_its_sv_shared_tracks_fig1->Fill(miss_dist_min_own.significance(), w);

									h_2D_miss_dist_phi_absdeltaphi0_large_sv_fig1->Fill(miss_dist_max.value(), double(fabs(reco::deltaPhi(phi0, sv0.track_phi[max_sv0_track_idx]))));
									h_2D_miss_dist_phi_absdeltaphi1_large_sv_fig1->Fill(miss_dist_min.value(), double(fabs(reco::deltaPhi(phi1, sv1.track_phi[min_sv1_track_idx]))));

									h_2D_pt_dxy_absdeltaphi0_large_sv_fig1->Fill(sv0.track_pt(max_sv0_track_idx), sv0.track_dxy[max_sv0_track_idx]);
									h_2D_pt_dxy_absdeltaphi1_large_sv_fig1->Fill(sv1.track_pt(min_sv1_track_idx), sv1.track_dxy[min_sv1_track_idx]);


									h_vertex_chi2dof_absdeltaphi0_large_nsv2_fig1->Fill(sv0.chi2dof(), w);
								}
							...
							if ((dphi_large_sv1_sharedjet > dphi_large_sv0_sharedjet) && (nsharedjet_tracks_sv1[i] < nsharedjet_tracks_sv0[i])) {
								...
								if ((miss_dist_max.value() < 0.025) && (miss_dist_min.value() < 0.025)) {		 // fig1
									...
									h_max_absdeltaphi0_large_sv_shared_jets_fig1->Fill(dphi_large_sv1_sharedjet, w);
									h_max_absdeltaphi1_large_sv_shared_jets_fig1->Fill(dphi_large_sv0_sharedjet, w);

									double ratio_ntracks_nsv2_fig1 = nsharedjet_tracks_sv0[i] / nsharedjet_tracks_sv1[i];
									h_ratio_ntracks_large_nsv2_shared_jets_fig1->Fill(ratio_ntracks_nsv2_fig1);
									...
									for (int j = 0; j < nsharedjet_tracks_sv0[i]; j++) {
										...
										double absdelta_jet_track = double(fabs(reco::deltaPhi(mevent->jet_phi[jet_index], sv0.track_phi[track_idx])));
										h_absdeltaphi_large_jet_shared_tracks_nsv2_fig1->Fill(absdelta_jet_track, w);
										h_pt_good_shared_tracks_large_nsv2_fig1->Fill(sv0.track_pt(track_idx), w);
										h_dxy_good_shared_tracks_large_nsv2_fig1->Fill(sv0.track_dxy[track_idx], w);
										absdeltaphi_min_sv0_shared_tracks.push_back(absdelta_min_sv0_track);
										std::cout << "sv1>sv0 : phi0 is " << phi0 << " with track phi " << sv0.track_phi[track_idx] << ", deltaPhi(jet,trk) is " << double(fabs(reco::deltaPhi(mevent->jet_phi[jet_index], sv0.track_phi[track_idx]))) << std::endl;
									}
									double min_dphi_sv0_track = *std::min_element(absdeltaphi_min_sv0_shared_tracks.begin(), absdeltaphi_min_sv0_shared_tracks.end());
									...
									int min_sv0_track_idx = sv0_nsharedjets1_which_idx[min_dphi_sv0_track_idx];
									h_max_absdeltaphi1_large_sv_shared_tracks_fig1->Fill(double(fabs(reco::deltaPhi(phi0, sv0.track_phi[min_sv0_track_idx]))), w);
									h_max_pt_absdeltaphi1_large_sv_shared_tracks_fig1->Fill(sv0.track_pt(min_sv0_track_idx), w);
									...
									for (int j = 0; j < nsharedjet_tracks_sv1[i]; j++) {
										...
										double absdelta_jet_track = double(fabs(reco::deltaPhi(mevent->jet_phi[jet_index], sv1.track_phi[track_idx])));
										h_absdeltaphi_large_jet_shared_tracks_nsv2_fig1->Fill(absdelta_jet_track, w);
										h_pt_poor_shared_tracks_large_nsv2_fig1->Fill(sv1.track_pt(track_idx), w);
										h_dxy_poor_shared_tracks_large_nsv2_fig1->Fill(sv1.track_dxy[track_idx], w);
										absdeltaphi_max_sv1_shared_tracks.push_back(absdelta_max_sv1_track);
										std::cout << "sv1>sv0 : phi1 is " << phi1 << " with track phi " << sv1.track_phi[track_idx] << ", deltaPhi(jet,trk) is " << double(fabs(reco::deltaPhi(mevent->jet_phi[jet_index], sv1.track_phi[track_idx]))) << std::endl;
									}
									double max_dphi_sv1_track = *std::max_element(absdeltaphi_max_sv1_shared_tracks.begin(), absdeltaphi_max_sv1_shared_tracks.end());
									...
									int max_sv1_track_idx = sv1_nsharedjets1_which_idx[max_dphi_sv1_track_idx];
									h_max_absdeltaphi0_large_sv_shared_tracks_fig1->Fill(double(fabs(reco::deltaPhi(phi1, sv1.track_phi[max_sv1_track_idx]))), w);
									h_max_pt_absdeltaphi0_large_sv_shared_tracks_fig1->Fill(sv1.track_pt(max_sv1_track_idx), w);
									...
									h_2D_miss_dist_phi_absdeltaphi0_large_sv_fig1->Fill(miss_dist_max.value(), double(fabs(reco::deltaPhi(phi1, sv1.track_phi[max_sv1_track_idx]))));
									h_2D_miss_dist_phi_absdeltaphi1_large_sv_fig1->Fill(miss_dist_min.value(), double(fabs(reco::deltaPhi(phi0, sv0.track_phi[min_sv0_track_idx]))));

									h_2D_pt_dxy_absdeltaphi0_large_sv_fig1->Fill(sv1.track_pt(max_sv1_track_idx), sv1.track_dxy[max_sv1_track_idx]);
									h_2D_pt_dxy_absdeltaphi1_large_sv_fig1->Fill(sv0.track_pt(min_sv0_track_idx), sv0.track_dxy[min_sv0_track_idx]);

									h_vertex_chi2dof_absdeltaphi0_large_nsv2_fig1->Fill(sv1.chi2dof(), w);
